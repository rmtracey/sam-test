...
This is a sample template for sam-slack-test - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name sam-slack-test --tail
```
...
```bash
aws cloudformation delete-stack --stack-name sam-slack-test
```
